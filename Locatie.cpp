...
Locatie::~Locatie() {
    Utils::DeallocChar(m_szNumeLocatie);
}
...
std::string Locatie::getNumeLocatie() const {
    return m_szNumeLocatie;
}

int Locatie::getNrMaximLocuri() const {
    return m_iNrMaximLocuri;
}
...
void Locatie::setNrMaximLocuri(int iNrMaximLocuri) {
    if (iNrMaximLocuri > 0) {
        ...
        std::cout << "Numarul maxim de locuri trebuie sa fie mai mare decat 0!" << std::endl;
    }
}
...
void Locatie::setNrMaximRanduri(int iNrMaximRanduri) {
    if (iNrMaximRanduri > 0) {
        ...
        std::cout << "Numarul maxim de randuri trebuie sa fie mai mare decat 0!" << std::endl;
    }
}
